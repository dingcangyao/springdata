...
public class PrimaryJpaConfig {
    static final String REPOSITORY_PACKAGE = "com.yaoge.springboothibernate.repository.primary";
    private static final String ENTITY_PACKAGE = "com.yaoge.springboothibernate.pojo.primary";
